...
public class GUI extends JDialog{
    ...
    public JPanel peterPanel= new JPanel();
    ...
    private JButton Versuch;
    public static int i = 0;



    public GUI() throws IOException {
        peterPanel.setSize(new Dimension(1000, 1000));
        setContentPane(peterPanel);
    ...
    public void ImagePanel() {
        try
        {
            ...
            BufferedImage img = ImageIO.read(new File("D:\\Schule\\Oberstufe\\Semester_2\\Informatik\\Mompoly\\Mompoly.git\\branches\\dateien\\7b96e3c52e814c3a26279d978e1b847c.jpg"));
